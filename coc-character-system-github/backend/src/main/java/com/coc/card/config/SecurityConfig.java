package com.coc.card.config;

import com.coc.card.common.ApiResponse;
import com.coc.card.security.JwtAuthenticationFilter;
...
/**
 * Spring Security 配置：无状态 JWT，接口分级权限
 */
@Configuration
public class SecurityConfig {
        ...
        http
                ...
                .exceptionHandling(ex -> ex
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) ->
                                writeError(response, 403, "没有操作权限")))
    ...
    /**
     * 开发期跨域配置：允许 Vue 开发服务器（任意端口）携带 Authorization 头访问
     */
    @Bean
